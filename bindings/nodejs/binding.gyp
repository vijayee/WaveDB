  ...
  "targets": [
    {
      ...
      "conditions": [
        ["OS=='win'", {
          "defines": ["_WIN32", "_CRT_NONSTDC_NO_WARNINGS", "CBOR_RESTRICT_SPECIFIER="]
        }]
      ]
    },
    {
      ...
      "conditions": [
        ...
        ["OS=='win'", {
          "defines": ["_WIN32", "_CRT_NONSTDC_NO_WARNINGS", "CBOR_RESTRICT_SPECIFIER="],
          "libraries": ["ws2_32.lib", "bcrypt.lib"],
          "msvs_settings": {
            "VCCLCompilerTool": {
              "CLanguageStandard": "stdc11",
              "AdditionalOptions": ["/experimental:c11atomics"]
            }
          }
        }]
      ]
